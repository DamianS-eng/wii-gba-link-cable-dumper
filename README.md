...
- If there are compiler issues, ensure the latest dependencies are installed using `pacman -syuu`, and make sure you clean between compiles (`make clean`, refer to [build.bat](https://github.com/DamianS-eng/wii-gba-link-cable-dumper/blob/master/build.bat) for specific commands).
